function getCapIDsByRefContactNBR(conNbr){
	...
	var selectString = "select DISTINCT B1_PER_ID1, B1_PER_ID2, B1_PER_ID3 from B3CONTACT WHERE SERV_PROV_CODE= ? AND G1_CONTACT_NBR = ? AND B1_CONTACT_TYPE = ? AND REC_STATUS='A'";
