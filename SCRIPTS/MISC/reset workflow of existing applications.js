...
var c = aa.cap.getByAppType("Licenses",null,null,"Application").getOutput();

aa.print(c.length);

for (I in c) {
   var capId = c[I].getCapID();
   aa.print(capId.getCustomID());
   var result = aa.workflow.deleteAndAssignWorkflow(capId, "CAN_GEN_APP", true).getSuccess();
   aa.print(result);
